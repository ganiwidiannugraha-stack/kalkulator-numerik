...
export default function Home() {
  return (
    <main className="min-h-screen p-4 md:p-8 lg:p-12 relative overflow-hidden bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto space-y-8 relative z-10">
        <header className="space-y-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight flex justify-center items-center gap-4 flex-wrap">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-slate-100 via-cyan-200 to-fuchsia-300">
