        ...
        mvk.layouts = [
          {
            ...
            rows: [
              [
                ...
                { class: 'separator w5' },
                { label: '7', key: '7', class: 'keycap' },
                { label: '8', key: '8', class: 'keycap' },
                { label: '9', key: '9', class: 'keycap' },
                { latex: '\\div', class: 'keycap action' },
                { class: 'separator w5' },
              ...
              [
                ...
                { class: 'separator w5' },
                { label: '4', key: '4', class: 'keycap' },
                { label: '5', key: '5', class: 'keycap' },
                { label: '6', key: '6', class: 'keycap' },
                { latex: '\\times', class: 'keycap action' },
                { class: 'separator w5' },
                { latex: '\\log', class: 'keycap font-bold' },
                { latex: '\\ln', class: 'keycap font-bold' },
                { latex: '\\pi', class: 'keycap font-bold' }
              ],
              [
              ...
              [
                ...
                { label: '⏎', command: ['performWithFeedback', 'commit'], class: 'keycap action' }
              ]
            ]
          },
          'symbols',
