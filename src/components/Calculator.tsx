...
export default function Calculator() {
  ...
  React.useEffect(() => {
    if (mfRef.current) {
      ...
      const handler = (e: any) => {
        const val = e.target.getValue('ascii-math');
        const pythonSafe = val.replace(/\^/g, '**');
        setEqStr(pythonSafe);
      };
            ...
            <div className="space-y-5">
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-500">
                  Klik di area atas untuk memunculkan keyboard matematika. Gunakan keyboard untuk mengetik fungsi seperti pangkat atau trigonometri.
                </p>
              </div>
