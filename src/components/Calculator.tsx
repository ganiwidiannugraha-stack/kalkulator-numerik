            ...
            <div className="space-y-5">
              <div>
                  ...
                  {React.createElement('math-field', {
                    ...
                    onInput: (e: any) => {
                      try {
                        ...
                        // 1. Angka ketemu huruf: 3x -> 3*x
                        pythonSafe = pythonSafe.replace(/(\d)([a-zA-Z])/g, '$1*$2');
                        // 2. Huruf ketemu fungsi/konstanta: x e -> x*e, x sin -> x*sin
                        pythonSafe = pythonSafe.replace(/([a-zA-Z])\s+(e|exp|sin|cos|tan|log|ln|abs|sqrt)/g, '$1*$2');
                        // 3. Kurung tutup ketemu huruf: )x -> )*x
                        pythonSafe = pythonSafe.replace(/(\))([a-zA-Z])/g, '$1*$2');
                        // 4. Huruf ketemu kurung buka: x( -> x*(
                        pythonSafe = pythonSafe.replace(/([a-zA-Z0-9])\s*\(/g, '$1*(');
                        // Tapi pastikan 'cos(' tidak menjadi 'cos*('
                ...
                <div className="bg-slate-100 dark:bg-slate-800/50 p-3 rounded-lg text-xs text-slate-600 dark:text-slate-400 mt-3 border border-slate-200 dark:border-slate-700/50">
                  ...
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 list-disc list-inside ml-1">
                    <li><strong>Pangkat:</strong> Ketik <code className="text-cyan-600 dark:text-cyan-400 font-bold">^</code> (contoh: <code className="text-slate-800 dark:text-slate-200">x^2</code>) atau tombol <code className="text-slate-800 dark:text-slate-200">x²</code></li>
                    <li><strong>Eksponensial:</strong> Ketik <code className="text-slate-800 dark:text-slate-200">e^x</code> atau <code className="text-slate-800 dark:text-slate-200">exp(x)</code></li>
                    <li><strong>Pecahan:</strong> Ketik <code className="text-cyan-600 dark:text-cyan-400 font-bold">/</code> otomatis jadi per</li>
                    <li><strong>Fungsi Khusus:</strong> Ketik <code className="text-slate-800 dark:text-slate-200">sin(x)</code>, <code className="text-slate-800 dark:text-slate-200">ln(x)</code>, <code className="text-slate-800 dark:text-slate-200">log(x)</code>, <code className="text-slate-800 dark:text-slate-200">abs(x)</code></li>
                  </ul>
                </div>
              </div>
