  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="bg-slate-50/80 dark:bg-slate-900/80 border border-fuchsia-500/20 rounded-xl p-6 relative overflow-hidden">
        ...
        <div className="text-4xl font-mono text-slate-900 dark:text-slate-100 mb-6">{data.C1.toFixed(6)}</div>
        ...
        {exact !== null && (
          <div className="text-sm space-y-3 border-t border-slate-200 dark:border-slate-800 pt-5">
            <div className="flex justify-between text-slate-700 dark:text-slate-400">
              ...
              <span className="font-mono text-slate-900 dark:text-slate-100">{exact.toFixed(6)}</span>
            </div>
            <div className="flex justify-between text-slate-700 dark:text-slate-400">
              <span>Residu Galat Kesalahan:</span>
              <span className="font-mono text-fuchsia-500 font-bold">{Math.abs(exact - data.C1).toFixed(6)}</span>
            </div>
          </div>
        )}
      </div>
          ...
          <table className="w-full text-sm text-left text-slate-700 dark:text-slate-300">
            ...
            <tbody className="divide-y divide-slate-800/50 font-mono">
              <tr>
                ...
                <td className="px-4 py-3 text-fuchsia-500 font-bold">{data.C1 ? data.C1.toFixed(6) : '-'}</td>
              </tr>
              <tr>
